...
predictor = dlib.shape_predictor("E:/A_课设/fatigue_detecting-master/model/shape_predictor_68_face_landmarks.dat")
 
# 第三步：分别获取左右眼面部标志的索引
(lStart, lEnd) = face_utils.FACIAL_LANDMARKS_IDXS["left_eye"]77
