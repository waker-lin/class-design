...
COVER = "E:/A_课设/fatigue_detecting-master/images/camera.png"
...
class Fatigue_detecting(wx.Frame):
    ...
    def _learning_face(self,event):
        ...
        self.predictor = dlib.shape_predictor("D:\python.way\pythonProject8\shape_predictor_68_face_landmarks.dat")
